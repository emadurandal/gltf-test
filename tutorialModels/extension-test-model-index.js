...
TutorialExtensionTestModelIndex.List = [
    ...
    {category:'tutorialModels', name:'ChronographWatch', screenshot:'screenshot/screenshot.jpg', scale:0.5},
    ...
    {category:'tutorialModels', name:'CommercialRefrigerator', screenshot:'screenshot/screenshot.jpg', scale:1},
    {category:'tutorialModels', name:'CubeVisibility', screenshot:'screenshot/screenshot_animated.webp', scale:0.5},
    ...
    {category:'tutorialModels', name:'DiffuseTransmissionTest', screenshot:'screenshot/screenshot.jpg', scale:0.5},
    ...
    {category:'tutorialModels', name:'LightVisibility', screenshot:'screenshot/screenshot_animated.webp', scale:0.3},
    ...
    {category:'tutorialModels', name:'MeshoptCubeTest', screenshot:'screenshot/screenshot.png', scale:0.1},
    {category:'tutorialModels', name:'MosquitoInAmber', screenshot:'screenshot/screenshot.jpg', scale:30},
    {category:'tutorialModels', name:'NodeVisibilityTest', screenshot:'screenshot/screenshot.png', scale:0.1},
    ...
    {category:'tutorialModels', name:'TransmissionOrderTest', screenshot:'screenshot/screenshot.jpg', scale:0.5},
    ...
    {category:'tutorialModels', name:'USDShaderBallForGltf', screenshot:'screenshot/screenshot.jpg', scale:20},
